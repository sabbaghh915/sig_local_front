...
export default function PaymentForeign() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      {/* Header */}
      <div className="bg-gradient-to-r from-red-700 to-red-700 shadow-lg border-b border-red-800">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/90">دفع التأمين الحدودي (سيارات أجنبية)</p>
              </div>
            </div>
